...
public class Yingzz extends Spider {


    private static final String siteUrl = "http://www.yingzhazha.com";
    ...
    public String homeContent(boolean filter) {
        ...
        for (Element element : doc.select(".main > div > div.module > div:nth-child(2) > div > a")) {
    ...
    public String detailContent(List<String> ids) {
        ...
        String content = doc.select(".module-info-introduction-content > span:nth-child(1)").text();
        String director = doc.select("div.module-info-item:nth-child(2) > div:nth-child(2)").text();
        ...
        Elements sourceList = doc.select("div.sort-list > div > div");
